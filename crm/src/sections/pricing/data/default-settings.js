...
export const DEFAULT_PAPER_SETTINGS = {
    ...
    processing: [
        { id: 1, name: 'Cắt thành phẩm', unit: 'per_sheet', tiers: [{ max: 5, price: 5000, unit: 'per_lot' }, { max: 100, price: 10000, unit: 'per_lot' }, { max: 300, price: 150, unit: 'per_item' }, { max: 999999, price: 100 }], fixedTiers: [{ max: 100, fixed: 10000 }, { max: 200, fixed: 20000 }, { max: 300, fixed: 30000 }] },
        { id: 2, name: 'Bế demi', tiers: [{ max: 5, price: 4000, unit: 'per_sheet' }, { max: 20, price: 3000, unit: 'per_sheet' }, { max: 50, price: 2000, unit: 'per_sheet' }, { max: 150, price: 1800, unit: 'per_sheet' }, { max: 250, price: 1500, unit: 'per_sheet' }, { max: 350, price: 1300, unit: 'per_sheet' }, { max: 450, price: 1100, unit: 'per_sheet' }, { max: 550, price: 1000, unit: 'per_sheet' }, { max: 999999, price: 950, unit: 'per_sheet' }] },
        { id: 1772985502023, name: 'Bế Đứt', unit: 'per_sheet', tiers: [{ max: 5, price: 4800, unit: 'per_sheet' }, { max: 20, price: 3600, unit: 'per_sheet' }, { max: 50, price: 2400, unit: 'per_sheet' }, { max: 150, price: 2200, unit: 'per_sheet' }, { max: 250, price: 1800, unit: 'per_sheet' }, { max: 350, price: 1600, unit: 'per_sheet' }, { max: 450, price: 1300, unit: 'per_sheet' }, { max: 550, price: 1200, unit: 'per_sheet' }, { max: 999999, price: 1150, unit: 'per_sheet' }] },
        { id: 3, name: 'Bế + Cấn', unit: 'per_sheet', tiers: [{ max: 5, price: 7000, unit: 'per_sheet' }, { max: 20, price: 5200, unit: 'per_sheet' }, { max: 50, price: 3500, unit: 'per_sheet' }, { max: 150, price: 3100, unit: 'per_sheet' }, { max: 250, price: 2600, unit: 'per_sheet' }, { max: 350, price: 2300, unit: 'per_sheet' }, { max: 450, price: 1900, unit: 'per_sheet' }, { max: 550, price: 1800, unit: 'per_sheet' }, { max: 999999, price: 1700, unit: 'per_sheet' }] },
        { id: 6, name: 'Cấn thành phẩm', tiers: [{ max: 100, price: 10000 }, { max: 200, price: 15000 }, { max: 300, price: 20000 }, { max: 999999, price: 150, unit: 'per_item' }], fixedTiers: [{ max: 100, fixed: 10000 }, { max: 200, fixed: 20000 }, { max: 300, fixed: 30000 }] },
        { id: 4, name: 'Cấn răng cưa', tiers: [{ max: 100, price: 15000 }, { max: 200, price: 20000 }, { max: 300, price: 25000 }, { max: 999999, price: 170, unit: 'per_item' }], fixedTiers: [{ max: 100, fixed: 10000 }, { max: 200, fixed: 20000 }, { max: 300, fixed: 30000 }] },
        { id: 7, name: 'Đục lỗ', tiers: [{ max: 100, price: 10000 }, { max: 200, price: 20000 }, { max: 300, price: 30000 }, { max: 999999, price: 80, unit: 'per_item' }], fixedTiers: [{ max: 100, fixed: 10000 }, { max: 200, fixed: 20000 }, { max: 300, fixed: 30000 }] },
        { id: 9, name: 'Bo góc', tiers: [{ max: 20, price: 10000 }, { max: 50, price: 15000 }, { max: 100, price: 20000 }, { max: 200, price: 30000 }, { max: 999999, price: 100, unit: 'per_item' }], fixedTiers: [{ max: 100, fixed: 10000 }, { max: 200, fixed: 20000 }, { max: 300, fixed: 30000 }] },
    ],
    customerTypes: [
        { id: 2, name: 'Đại Lí', profit: 25 },
