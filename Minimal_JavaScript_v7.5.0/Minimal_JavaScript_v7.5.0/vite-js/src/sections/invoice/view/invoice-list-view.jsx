...
const TABLE_HEAD = [
  ...
  { id: 'dueDate', label: 'Hạn thanh toán' },
  { id: 'price', label: 'Số tiền' },
...
export function InvoiceListView() {
  ...
  const renderConfirmDialog = () => (
    <ConfirmDialog
      ...
      content={
        <>
          Bạn có chắc muốn xóa <strong> {table.selected.length} </strong> mục?
        </>
      }
      action={
        <Button
      ...
      <DashboardContent>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: 'Hóa đơn', href: paths.dashboard.invoice.root },
            { name: 'Danh sách' },
          ]}
          action={
            <Button
